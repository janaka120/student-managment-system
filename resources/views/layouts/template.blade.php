...
<div class="wrapper">
    <div class="sidebar" data-color="purple" data-image="{{ URL::asset('images/sidebar-5.jpg') }}">
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a>SIS</a>, made with love for a better web
                </p>
            </div>
        </footer>
